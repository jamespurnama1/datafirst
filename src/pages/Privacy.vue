<template>
  <main class="mt-12 md:mt-24 lg:mt-52 pb-10 md:pb-20 px-12 md:px-32 lg:px-52">
    ...
    <br>
    If at any time you have questions about our practices or any of your rights described below, you may reach our dedicated team that supports this office by contacting us at <a class="underline" href="mailto:info@datafirstservices.com">info@datafirstservices.com</a>. This inbox is actively monitored and managed so that we can deliver an experience that you can confidently trust.
    <br>
    <br>
    ...
    <ul>
      ...
      <li>In the event we need to share your information to provide the products or services requested, such as in the case of a third party integration authorized by you.</li>
    </ul>
    <br>
    ...
    <br>
    To the extent we are legally permitted to do so, we may take reasonable steps to notify you if we are required to provide your personal information to third parties as part of the legal process.
    <br>
    <br>
    ...
    <br>
    If you have any questions about the security or retention of your personal information, you can contact us at <a class="underline" href="mailto:info@datafirstservices.com">info@datafirstservices.com</a>.
    <br>
    <br>
    <strong>How you can access, update or delete your data.</strong>
    <br>
    To easily update your personal information, or to update your subscription preferences, you may submit your request to <a class="underline" href="mailto:info@datafirstservices.com">info@datafirstservices.com</a>
    <br>
    ...
    <br>
    Our Services are available for purchase only for those over the age of 18. Our Services are not targeted to, intended to be consumed by or designed to entice individuals under the age of 18. If you know of or have reason to believe anyone under the age of 18 has provided us with any personal information, please contact us per the instructions provided below.
    <br>
    <br>
    ...
    <br>
    If you have any questions, concerns, or complaints about our Privacy Policy, or how we handle your personal data, you may contact our office by email at <a class="underline" href="mailto:info@datafirstservices.com">info@datafirstservices.com</a>. 
    <br>
    In the alternative, you may contact us by either of the following means:
    <br>
    By Mail: <a class="underline" href="mailto:info@datafirstservices.com">info@datafirstservices.com</a>
    <br>
    By Phone: <a class="underline" href="tel:+97142027713">+971 4 202 7713</a>
    <br>
