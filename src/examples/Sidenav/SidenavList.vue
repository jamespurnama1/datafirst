    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? 'الجداول' : 'Blog Posts'"
        >
          <template v-slot:icon>
            <i
              class="ni ni-align-left-2 text-warning text-sm opacity-10"
            ></i>
          </template>
        </sidenav-item>
      </li>
      <!-- <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? 'الفواتیر' : 'New Post'"
        >
          <template v-slot:icon>
            <i class="ni ni-pencil text-success text-sm opacity-10"></i>
          </template>
        </sidenav-item>
      </li> -->
      <li class="nav-item">
        <sidenav-item
          url="/jobs"
          :class="getRoute() === 'jobs' ? 'active' : ''"
          :navText="this.$store.state.isRTL ? 'الجداول' : 'Job Posts'"
        >
          <template v-slot:icon>
            <i
