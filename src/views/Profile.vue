        ...
        <div class="card-body p-3">
          <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
              <div class="h-100">
                <h5 class="mb-1">{{ store.state.user ? store.state.user.displayName || store.state.user.email : '' }}</h5>
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                ...
                <argon-button :disabled="store.state.user.uid === superAdmin" @click="confirm = true" color="danger" size="sm" class="ms-auto">Delete Account</argon-button>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <argon-input :disabled="store.state.user.uid === superAdmin" @value="(x) => name = x" type="text" :value="store.state.user.displayName ? store.state.user.displayName : ''" />
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label">Email address</label>
                  <argon-input :disabled="store.state.user.uid === superAdmin" @value="(x) => email = x" type="email" :value="store.state.user.email" />
                </div>
                <div class="d-flex align-items-center">
                  <argon-button :disabled="store.state.user.uid === superAdmin" @click="apply()" color="success" size="sm" class="ms-auto">Apply</argon-button>
                </div>
                <!-- <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="example-text-input" class="form-control-label">Change Password</label>
                  <argon-input @value="(x) => pass = x.value" type="password" placeholder="********" />
                </div>
                <div class="d-flex align-items-center">
                  <argon-button @click="pass ? updatePass(pass) : null" color="success" size="sm" class="ms-auto">Change Password</argon-button>
                </div>
              </div>
            </div>
          </div>
...
import { updatePass, updateUser, updateMail, delUser } from '@/firebase'
