<template>
  ...
  <main class="main-content mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
      style="background-image: url('/cover.jpg'); background-position: top;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Dashboard</h1>
            <p class="text-lead text-white">Manage blog, job listings, and admin roles.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            <div class="card-header text-center pt-4">
              <h5 v-if="route.name === 'Reset'">Reset password</h5>
              <h5 v-else>Request Access</h5>
            </div>
            ...
            <div class="card-body">
              <form role="form">
                ...
                <argon-input @value="(x) => email = x.value" type="email" placeholder="Email" aria-label="Email" />
                ...
                <div class="text-center">
                  <argon-button @click.prevent="email ? resetPass(email) : null" v-if="route.name === 'Reset'" fullWidth color="dark" variant="gradient"
                    class="my-4 mb-2">Reset</argon-button>
                  <argon-button v-else fullWidth color="dark" variant="gradient" class="my-4 mb-2">Request</argon-button>
                </div>
